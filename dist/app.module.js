...
let AppModule = class AppModule {
    configure(consumer) {
        consumer.apply(validation_middleware_1.ValidationMiddleware).forRoutes({ path: "/products/products", method: common_1.RequestMethod.GET }, { path: "/products/product", method: common_1.RequestMethod.POST }, { path: "/products/product", method: common_1.RequestMethod.PUT }, { path: "/products/product", method: common_1.RequestMethod.DELETE }, { path: "/products/fields", method: common_1.RequestMethod.GET }, { path: "/products/category", method: common_1.RequestMethod.GET }, { path: "/products/categories", method: common_1.RequestMethod.GET }, { path: "/products/cities", method: common_1.RequestMethod.GET }, { path: "/products/state", method: common_1.RequestMethod.GET }, { path: "/products/myproducts", method: common_1.RequestMethod.GET }, { path: "/products/products/city", method: common_1.RequestMethod.GET }, { path: "/products/products/categories", method: common_1.RequestMethod.GET }, { path: "/user/signup", method: common_1.RequestMethod.POST }, { path: "/user/login", method: common_1.RequestMethod.PUT }, { path: "/user/logout", method: common_1.RequestMethod.PUT }, { path: "/user/getInfo", method: common_1.RequestMethod.GET }, { path: "/user/updateInfo", method: common_1.RequestMethod.POST }, { path: "/user/delete", method: common_1.RequestMethod.DELETE });
    }
};
